...
set(jsoncpp_headers "${CMAKE_SOURCE_DIR}/src/jsoncpp/include"  CACHE STRING "" FORCE)
...
set(liblog_headers "${CMAKE_SOURCE_DIR}/src/logging/liblog/include" CACHE STRING "" FORCE)
